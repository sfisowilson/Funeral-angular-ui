                ...
                <div class="col-md-8 col-lg-6">
                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body text-center p-5">
                            ...
                            <p class="lead text-muted mb-4">Thank you for your payment. Your transaction has been completed successfully.</p>
                            ...
                            <div class="alert alert-info mb-4" role="alert">
                                ...
                                <p class="mb-0 small mt-2">Your account has been created successfully! Please log in with your credentials to access your dashboard. A confirmation email will be sent once your account is fully configured.</p>
                            </div>

                            <!-- Action Buttons -->
                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                <button class="btn btn-primary btn-lg" (click)="goToDashboard()"><i class="bi bi-box-arrow-in-right me-2"></i>Go to Login</button>
                                <button class="btn btn-outline-secondary btn-lg" (click)="viewTransactions()"><i class="bi bi-receipt me-2"></i>View Transactions</button>
                            </div>

                            <!-- Print Receipt -->
                            <div class="mt-4">
                                <button class="btn btn-link text-muted" (click)="printReceipt()"><i class="bi bi-printer me-1"></i>Print Receipt</button>
                            </div>
                        </div>
                    </div>

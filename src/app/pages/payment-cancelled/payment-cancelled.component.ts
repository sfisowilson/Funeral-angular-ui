                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body text-center p-5">
                            ...
                            <p class="lead text-muted mb-4">
                                {{ isFailed ? 'Your payment could not be processed. Please try again or contact support if the problem persists.' : 'Your payment has been cancelled. No charges have been made to your account.' }}
                            </p>
                            ...
                            <div class="alert alert-warning mb-4" role="alert">
                                <h6 class="alert-heading"><i class="bi bi-exclamation-triangle me-2"></i>Common Reasons for Payment Issues</h6>
                            ...
                            <div class="d-grid gap-2">
                                <button class="btn btn-primary btn-lg" (click)="retryPayment()"><i class="bi bi-arrow-clockwise me-2"></i>Try Again</button>
                                <button class="btn btn-outline-secondary" (click)="goToDashboard()"><i class="bi bi-house-door me-2"></i>Return to Dashboard</button>
                                <button class="btn btn-outline-info" (click)="contactSupport()"><i class="bi bi-headset me-2"></i>Contact Support</button>
                            </div>
                            ...
                            <div class="mt-4 pt-4 border-top">
                                ...
                                <p class="text-muted small">We accept multiple payment methods including credit cards, debit cards, and instant EFT. Visit your profile settings to manage payment methods.</p>
                            </div>
                        </div>
                    </div>

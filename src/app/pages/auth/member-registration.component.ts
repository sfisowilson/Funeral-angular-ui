...
import { MemberRegistrationServiceProxy, CheckIdNumberDto, CheckIdNumberResponseDto, RegisterNewMemberDto, RequestDependentOtpDto, VerifyDependentOtpDto, PolicyOptionDto } from '../../core/services/service-proxies';

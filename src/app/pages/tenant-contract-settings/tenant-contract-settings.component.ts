    ...
    template: `
        <div class="container mx-auto p-6">
            ...
            <div class="card mb-6">
                ...
                <div *ngIf="currentTemplate" class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        ...
                        <button (click)="removeTemplate()" class="btn btn-danger btn-sm"><i class="bi bi-trash me-2"></i>Remove</button>
                    </div>
                </div>
            ...
            <div class="card mb-6">
                ...
                <p class="text-gray-600 mb-4">Upload a PDF template with form fields that match the field names below.</p>

                <div class="mb-4">
                    <input type="file" (change)="onFileSelected($event)" accept=".pdf" #fileInput class="form-control" />
                </div>

                <button (click)="uploadTemplate()" [disabled]="!selectedFile || uploading" class="btn btn-primary">
            ...
            <!-- Field Naming Guide -->
            <div class="card">
                <h3 class="text-lg font-semibold mb-4"><i class="bi bi-info-circle text-primary me-2"></i>PDF Form Field Names</h3>
                <p class="text-gray-600 mb-4">Your PDF template must have form fields with the following exact names. The system will automatically fill these fields with member data.</p>

                <!-- Search/Filter -->
                <div class="mb-4">
                    <input type="text" [(ngModel)]="fieldSearch" placeholder="Search field names..." class="form-control" />
                </div>
                ...
                <div class="accordion" id="fieldAccordion">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingPersonal">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePersonal">Personal Information (9 fields)</button>
                        </h2>
                        <div id="collapsePersonal" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingContact">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseContact">Contact Information (5 fields)</button>
                        </h2>
                        <div id="collapseContact" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                            <div class="accordion-body">
                                <div class="field-grid">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingAddress">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAddress">Address Information (5 fields)</button>
                        </h2>
                        <div id="collapseAddress" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                            <div class="accordion-body">
                                <div class="field-grid">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingEmployment">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEmployment">Employment & Nationality (10 fields)</button>
                        </h2>
                        <div id="collapseEmployment" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                            <div class="accordion-body">
                                <div class="field-grid">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingBanking">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBanking">Banking Details (5 fields)</button>
                        </h2>
                        <div id="collapseBanking" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                            <div class="accordion-body">
                                <div class="field-grid">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingDependents">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDependents">Dependents (20 fields - 10 dependents)</button>
                        </h2>
                        <div id="collapseDependents" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingBeneficiaries">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBeneficiaries">Beneficiaries (30 fields - 10 beneficiaries)</button>
                        </h2>
                        <div id="collapseBeneficiaries" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                            <div class="accordion-body">
                                <p class="text-sm text-gray-600 mb-3">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingSystem">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSystem">System Fields (2 fields)</button>
                        </h2>
                        <div id="collapseSystem" class="accordion-collapse collapse" data-bs-parent="#fieldAccordion">
                            <div class="accordion-body">
                                <div class="field-grid">

...
import { CouponServiceProxy, Coupon, CouponStatsDto } from '../../../core/services/service-proxies';
...
export class CouponListComponent implements OnInit {
    ...
    deleteCoupon(coupon: any) {
        this.showConfirm(`Are you sure you want to delete the coupon "${coupon.name}"?`, async () => {
            try {

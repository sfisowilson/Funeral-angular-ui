...
import { PaymentServiceProxy, Payment } from '../../../core/services/service-proxies';
...
export class PaymentListComponent implements OnInit {
    ...
    async loadPayments() {
        try {
            ...
            const payments = await this.paymentService.payment_GetAll(undefined, undefined, this.statusFilter || undefined, this.gatewayFilter || undefined).toPromise();
            ...
            accept: async () => {
                try {
                    ...
                    await this.paymentService
                        .payment_Refund(this.selectedPayment!.id, {

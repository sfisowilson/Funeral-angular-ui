...
import { TenantSubscriptionServiceProxy, SubscriptionPlanServiceProxy, TenantSubscription, SubscriptionPlan } from '../../../core/services/service-proxies';
...
export class SubscriptionListComponent implements OnInit {
    ...
    async loadSubscriptions() {
        try {
            ...
            const subs = await this.subscriptionService.tenantSubscription_GetAll(undefined, undefined, this.statusFilter as any, this.searchText || undefined).toPromise();
    ...
    async changePlan() {
        ...
        try {
            ...
            await this.subscriptionService.tenantSubscription_ChangePlan(this.selectedSubscription.id, this.newPlanId as any).toPromise();

                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr *ngFor="let customer of filteredCustomers">
                            ...
                            <td>
                                <span class="badge" [ngClass]="customer.isActive ? 'bg-success' : 'bg-secondary'">{{ customer.isActive ? 'Active' : 'Inactive' }}</span>
                            </td>
...
export class CustomerManagementComponent implements OnInit {
    ...
    applyFilters(): void {
        this.filteredCustomers = this.customers.filter(
            (c) => !this.searchTerm || c.firstName.toLowerCase().includes(this.searchTerm.toLowerCase()) || c.lastName.toLowerCase().includes(this.searchTerm.toLowerCase()) || c.email.toLowerCase().includes(this.searchTerm.toLowerCase())
        );
    }

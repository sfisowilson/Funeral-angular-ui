...
import { DynamicEntityServiceProxy, DynamicEntityRelationDefinitionDto, DynamicEntityRecordDto, DynamicEntityTypeDto, SetRelationsForRecordDto, CreateDynamicEntityRelationDefinitionDto, UpdateDynamicEntityRelationDefinitionDto } from '@app/core/services/service-proxies';
...
export class DynamicEntityRelationManagementComponent implements OnInit {
  ...
  saveDefinition() {
    ...
    const body = isEdit
      ? new UpdateDynamicEntityRelationDefinitionDto()
      : new CreateDynamicEntityRelationDefinitionDto();
    ...
    const call = isEdit
      ? this.dynamicEntityService.relationDefinition_Update(body as UpdateDynamicEntityRelationDefinitionDto)
      : this.dynamicEntityService.relationDefinition_Create(body as CreateDynamicEntityRelationDefinitionDto);

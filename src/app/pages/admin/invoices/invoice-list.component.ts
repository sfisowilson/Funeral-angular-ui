...
import { InvoiceServiceProxy, Invoice } from '../../../core/services/service-proxies';
...
export class InvoiceListComponent implements OnInit {
    ...
    constructor(private invoiceService: InvoiceServiceProxy) {}
    ...
    async loadInvoices() {
        try {
            ...
            const invoices = await this.invoiceService.invoice_GetAll(undefined, undefined, this.statusFilter || undefined, this.searchText || undefined).toPromise();
            ...
            accept: async () => {
                try {
                    ...
                    await this.invoiceService
                        .invoice_Void(this.selectedInvoice!.id, {

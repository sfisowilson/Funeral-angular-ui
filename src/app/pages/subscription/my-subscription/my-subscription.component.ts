...
import { TenantSubscriptionServiceProxy, PaymentServiceProxy, InvoiceServiceProxy, TenantSubscription, Payment, Invoice } from '../../../core/services/service-proxies';
...
export class MySubscriptionComponent implements OnInit {
    ...
    async loadSubscriptionData() {
        try {
            ...
            await Promise.all([this.loadSubscription(), this.loadPayments(), this.loadInvoices()]);
        } catch (error) {

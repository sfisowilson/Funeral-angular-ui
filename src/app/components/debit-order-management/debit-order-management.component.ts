        ...
        <div class="container mx-auto p-6">
            ...
            <div class="bg-white shadow rounded-lg p-6 mb-6">
                ...
                <div class="flex gap-4 items-end">
                    <div>
                        ...
                        <input type="date" [(ngModel)]="processingDate" class="border rounded-lg px-3 py-2" />
                    </div>
                    <button (click)="createBatch()" [disabled]="creating" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50">
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr *ngFor="let batch of batches">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <button *ngIf="batch.status === 'Draft'" (click)="generateFile(batch.id)" class="text-blue-600 hover:text-blue-800 mr-2">Generate File</button>
                                <button (click)="viewBatch(batch.id)" class="text-gray-600 hover:text-gray-800">View</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="bg-white shadow rounded-lg p-6 mt-6">
                ...
                <div class="flex gap-4 items-center">
                    <input type="file" #fileInput (change)="onFileSelected($event)" accept=".txt,.csv" class="border rounded-lg px-3 py-2" />
                    <button (click)="uploadResponse()" [disabled]="!selectedFile || uploading" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 disabled:opacity-50">

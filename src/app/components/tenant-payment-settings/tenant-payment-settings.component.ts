        ...
        <div class="container mx-auto p-6">
            ...
            <div class="mb-6 border-b border-gray-200">
                <nav class="-mb-px flex space-x-8">
                    <button (click)="activeTab = 'banking'" [class.border-blue-600]="activeTab === 'banking'" [class.text-blue-600]="activeTab === 'banking'" class="py-4 px-1 border-b-2 font-medium text-sm">Banking Details</button>
                    <button *ngIf="isHostTenant" (click)="activeTab = 'collection'" [class.border-blue-600]="activeTab === 'collection'" [class.text-blue-600]="activeTab === 'collection'" class="py-4 px-1 border-b-2 font-medium text-sm">
                        Collection Account
                    </button>
                    <button *ngIf="isHostTenant" (click)="activeTab = 'debitorder'" [class.border-blue-600]="activeTab === 'debitorder'" [class.text-blue-600]="activeTab === 'debitorder'" class="py-4 px-1 border-b-2 font-medium text-sm">
            ...
            <div *ngIf="activeTab === 'banking'" class="bg-white shadow rounded-lg p-6">
                ...
                <form [formGroup]="bankingForm" (ngSubmit)="saveBankingDetails()">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" formControlName="accountNumber" class="w-full border rounded-lg px-3 py-2" placeholder="Enter account number" />
                        </div>

                        <div>
                            <label class="block text-sm font-medium mb-2">Branch Code *</label>
                            <input type="text" formControlName="branchCode" class="w-full border rounded-lg px-3 py-2" placeholder="Enter branch code" />
                        </div>

                        <div>
                            <label class="block text-sm font-medium mb-2">Account Holder Name *</label>
                            <input type="text" formControlName="accountHolderName" class="w-full border rounded-lg px-3 py-2" placeholder="Enter account holder name" />
                        </div>

                        <div>
                            <label class="block text-sm font-medium mb-2">Preferred Debit Day (1-31)</label>
                            <input type="number" formControlName="debitDay" min="1" max="31" class="w-full border rounded-lg px-3 py-2" placeholder="Day of month" />
                        </div>
                    ...
                    <div class="mt-6 flex gap-4">
                        <button type="submit" [disabled]="!bankingForm.valid || saving" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50">
                ...
                <div *ngIf="existingBanking" class="mt-6 p-4 bg-gray-50 rounded-lg">
                    ...
                    <span [class]="existingBanking.isVerified ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'" class="px-3 py-1 text-sm rounded-full">
            ...
            <div *ngIf="activeTab === 'collection' && isHostTenant" class="bg-white shadow rounded-lg p-6">
                ...
                <form [formGroup]="collectionForm" (ngSubmit)="saveCollectionAccount()">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-2">Account Number *</label>
                            <input type="text" formControlName="collectionAccountNumber" class="w-full border rounded-lg px-3 py-2" placeholder="Enter account number" />
                        </div>

                        <div>
                            <label class="block text-sm font-medium mb-2">Branch Code *</label>
                            <input type="text" formControlName="collectionBranchCode" class="w-full border rounded-lg px-3 py-2" placeholder="Enter branch code" />
                        </div>
                    </div>

                    <div class="mt-6">
                        <button type="submit" [disabled]="!collectionForm.valid || saving" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50">
                ...
                <form [formGroup]="debitOrderForm" (ngSubmit)="saveDebitOrderSettings()">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" formControlName="debitOrderUserId" class="w-full border rounded-lg px-3 py-2" placeholder="Your company user ID" />
                        </div>

                        <div>
                            <label class="block text-sm font-medium mb-2">Company Abbreviation (3-4 chars) *</label>
                            <input type="text" formControlName="debitOrderAbbreviation" maxlength="4" class="w-full border rounded-lg px-3 py-2" placeholder="e.g., COMP" />
                        </div>

                        <div>
                            <label class="block text-sm font-medium mb-2">Preferred Debit Day *</label>
                            <input type="number" formControlName="preferredDebitDay" min="1" max="31" class="w-full border rounded-lg px-3 py-2" placeholder="Day of month (1-31)" />
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium mb-2">Batch Output Path</label>
                            <input type="text" formControlName="debitOrderBatchPath" class="w-full border rounded-lg px-3 py-2" placeholder="./DebitOrderBatches" />
                        </div>
                    </div>

                    <div class="mt-6">
                        <button type="submit" [disabled]="!debitOrderForm.valid || saving" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50">

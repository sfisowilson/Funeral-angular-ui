                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr *ngFor="let invoice of invoices">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <button *ngIf="!invoice.isPaid" (click)="payInvoice(invoice)" class="text-blue-600 hover:text-blue-800 mr-2">Pay Now</button>
                                <button (click)="viewInvoice(invoice.id)" class="text-gray-600 hover:text-gray-800">View</button>
                            </td>
                        </tr>
                    </tbody>
                </table>

                <div *ngIf="invoices.length === 0" class="text-center py-8 text-gray-500">No invoices found</div>
            </div>
        </div>
    `
})

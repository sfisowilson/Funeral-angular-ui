    ...
    template: `
        <div class="container mx-auto p-6">
            ...
            <div *ngIf="existingDetails" class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                ...
                <button *ngIf="!existingDetails.isVerified" (click)="verifyBankingDetails()" class="mt-4 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Verify Banking Details</button>
            </div>
            ...
            <form [formGroup]="bankingForm" (ngSubmit)="saveBankingDetails()" class="bg-white shadow-md rounded-lg p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" formControlName="debitDay" min="1" max="31" class="w-full border rounded-lg px-3 py-2" placeholder="Preferred debit day" />
                    </div>
                ...
                <div class="mt-6 flex gap-4">
                    ...
                    <button type="button" (click)="resetForm()" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400">Reset</button>
                </div>

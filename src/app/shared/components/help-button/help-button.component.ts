...
@Component({
    ...
    template: `
        <div class="help-widget">
            <!-- Help Button -->
            <button class="help-trigger" [class.open]="helpOpen" (click)="toggleHelp()" title="Need help?">
            ...
            <div class="help-panel" *ngIf="helpOpen" @slideIn>
                ...
                <div class="help-content">
                    ...
                    <div class="search-box mb-3">
                        ...
                        <input type="search" class="form-control form-control-sm" placeholder="Search for help..." [(ngModel)]="searchQuery" />
                    </div>
                    ...
                    <div class="help-section border-top pt-3">
                        <button class="btn btn-sm btn-outline-secondary w-100" (click)="resetTours()"><i class="bi bi-arrow-clockwise me-2"></i>Reset All Tours</button>
                    </div>
                </div>
            </div>
        </div>

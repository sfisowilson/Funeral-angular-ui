...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, CardModule, TableModule, TagModule, ProgressSpinnerModule, ButtonModule, ToastModule],
            ...
            <p-card header="Your Monthly Premium Breakdown">
                ...
                <div *ngIf="!loading() && premiumResult()">
                        ...
                        <p-table [value]="premiumResult()!.breakdown" styleClass="p-datatable-sm">
                            ...
                            <ng-template pTemplate="body" let-item>
                                <tr>
                                    ...
                                    <td>{{ item.details }}</td>
                                    <td>
                                        <p-tag [value]="item.category === 'Base' ? 'Base Premium' : 'Extended Family'" [severity]="item.category === 'Base' ? 'info' : 'success'"> </p-tag>
                                    </td>
                    ...
                    <div class="action-buttons">
                        <button pButton label="Refresh Calculation" icon="pi pi-refresh" (click)="refreshCalculation()" class="p-button-outlined"></button>
                    </div>
                </div>
                ...
                <div *ngIf="!loading() && !premiumResult()" class="empty-state">
                    ...
                    <button pButton label="Calculate Premium" icon="pi pi-calculator" (click)="refreshCalculation()"></button>
                </div>
            </p-card>
        </div>
    `,

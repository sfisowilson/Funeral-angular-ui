    ...
    <header class="bg-white shadow-md">
      ...
      <nav *ngIf="mobileMenuOpen" class="md:hidden bg-white border-t border-gray-200 shadow-lg">
        <div class="px-4 py-4 space-y-1">
          <a
            [routerLink]="homeLink"
            class="block px-3 py-3 text-gray-600 hover:bg-gray-100 hover:text-blue-600 transition rounded"
          >
            Home
          </a>
          ...
          <ng-container *ngIf="!isStaticSite && !isLoggedIn">
            <a
              [href]="registerUrl"
              class="block px-3 py-3 text-blue-600 hover:bg-blue-50 font-semibold transition rounded"
            >
              Register
            </a>
            <a
          ...
          <ng-container *ngIf="!isStaticSite && isLoggedIn">
            ...
            <button
              ...
              class="block w-full text-left px-3 py-3 text-red-600 hover:bg-red-50 font-semibold transition rounded"
            >
              Logout
            </button>
          </ng-container>
